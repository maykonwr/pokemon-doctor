...
import { GlobalStyle, ContainerQuemSomos, ContentHeaderQuemSomos, GoToHome, TitleQuemSomos, TextQuemSomos, ContentQuemSomos } from './../Styled'
        ...
        <>      
            ...
            <ContainerQuemSomos>
                <ContentHeaderQuemSomos>
                    <GoToHome>{`Home > Quem Somos`}</GoToHome>
                    <TitleQuemSomos>Quem Somos</TitleQuemSomos>
                    <TextQuemSomos>A maior rede de tratamento pokémon.</TextQuemSomos>
                </ContentHeaderQuemSomos>
            </ContainerQuemSomos>
            <ContentQuemSomos>
