            ...
            <form onSubmit={handleSubmit(onSubmit)} action=''>
                ...
                <section>
                    ...
                    <Select 
                        ...
                        callBack={(selectedTime) => setIsTimeSelected(!!selectedTime)}
                    />
                </section>
                <section>
                    <div>
                    ...
                    <div>
                        ...
                        <Button type='submit' disabled={!isPokemonAdded || !isDateSelected || !isTimeSelected}>Concluir Agendamento</Button>
                    </div>
                </section>
            </form>
        </ContainerForm>
